...
var postcssLoader = {
  ...
  process({
    ...
    return _asyncToGenerator(function* () {
      ...
      if (options.postcss.firstPlugin) {
        plugins.unshift(options.postcss.firstPlugin);
...
var index = ((options = {}) => {
  ...
  return {
    ...
    augmentChunkHash() {
      ...
      const extractedValue = Array.from(extracted).reduce((obj, [key, value]) => _objectSpread({}, obj, {
        [key]: value
      }), {});
